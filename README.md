...
[![Build Status](https://travis-ci.org/fmonniot/asa-competition.svg?branch=master)](https://travis-ci.org/fmonniot/asa-competition)

A simple application to help http://archeragnetz.fr archery club manage their competition.

---

### Getting up and running

1. Clone this repo from `https://github.com/fmonniot/asa-competition.git`
...
You can also publish the current production version to the `gh-pages` of this repository by running `gulp deploy`.
...
Thanks to [Jake Marsh](http://jakemmarsh.com/) to have created an [amazing boilerplate](https://github.com/jakemmarsh/angularjs-gulp-browserify-boilerplate) project that have bootstrapped this project.
